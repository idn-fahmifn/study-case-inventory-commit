                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" id="input-file-now-custom-3" value="{{$data->foto_ruangan}}" name="foto_ruangan"
                                                        class="dropify" data-default-file="{{ asset('storage/images/ruangan/'.$data->foto_ruangan) }}" required />
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" id="input-file-now-custom-3" value="{{$data->denah_ruangan}}" name="denah_ruangan"
                                                        class="dropify" data-default-file="{{ asset('storage/images/denah/'.$data->denah_ruangan) }}" required />
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
